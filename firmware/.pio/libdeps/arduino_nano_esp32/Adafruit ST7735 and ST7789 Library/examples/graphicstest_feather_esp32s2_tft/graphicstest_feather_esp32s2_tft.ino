...
void testdrawrects(uint16_t color)
{
  ...
  for (int16_t x = 0; x < g_displayModule.width(); x += 6)
  {
    g_displayModule.drawRect(g_displayModule.width() / 2 - x / 2, g_displayModule.height() / 2 - x / 2, x, x,
                             color);
  }
}
...
void testfillrects(uint16_t color1, uint16_t color2)
{
  ...
  {
    g_displayModule.fillRect(g_displayModule.width() / 2 - x / 2, g_displayModule.height() / 2 - x / 2, x, x,
                             color1);
    g_displayModule.drawRect(g_displayModule.width() / 2 - x / 2, g_displayModule.height() / 2 - x / 2, x, x,
                             color2);
  }
...
void mediabuttons()
{
  // play
  g_displayModule.fillScreen(ST77XX_BLACK);
  g_displayModule.fillRoundRect(25, 5, 78, 60, 8, ST77XX_WHITE);
  g_displayModule.fillTriangle(42, 12, 42, 60, 90, 40, ST77XX_RED);
  delay(500);
  // pause
  g_displayModule.fillRoundRect(25, 70, 78, 60, 8, ST77XX_WHITE);
  g_displayModule.fillRoundRect(39, 78, 20, 45, 5, ST77XX_GREEN);
  g_displayModule.fillRoundRect(69, 78, 20, 45, 5, ST77XX_GREEN);
  delay(500);
  // play color
  g_displayModule.fillTriangle(42, 12, 42, 60, 90, 40, ST77XX_BLUE);
  delay(50);
  // pause color
  g_displayModule.fillRoundRect(39, 78, 20, 45, 5, ST77XX_RED);
  g_displayModule.fillRoundRect(69, 78, 20, 45, 5, ST77XX_RED);
  // play color
  g_displayModule.fillTriangle(42, 12, 42, 60, 90, 40, ST77XX_GREEN);
}
